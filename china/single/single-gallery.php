        ...
        <div class="row">
          <div class="col-lg-9">
             <div class="row">
              ...
              <div class="bg-white p-lg-5 p-1 my-5 rounded shadow" id="entry">
                ...
                <?php if(has_post_thumbnail()) : ?>
                     ...
                     <a href="<?php echo $featured_img_url; ?>" data-lightbox="<?php the_title(); ?>" data-title="<?php the_title(); ?>">
                        <?php the_post_thumbnail('fullpage-thumb', array('class' => 'w-100 img-fluid shadow img-thumbnail rounded animated fadeIn trans-200')); ?>  
                     </a>                  
                <?php else : ?>
