...
<head>
  ...
  <title>Page Not Found/Cathy's Website</title>
</head>
<body>
	<div class="container grid-container">	
		<p class="text grid-item">
			Link broken, <br><span class="highlight"><?php echo $userRequest ?></span> is not found.
		</p>	
		<div class="count-center grid-item">
			<div class="counter" data-count="404">0</div>
		</div>
		<div class="margin-b grid-item">
			<img src="<?php bloginfo( 'template_url' ); ?>/images/broken_world.jpg" alt="Broken World">
		</div>
		<h3 class="grid-item">
