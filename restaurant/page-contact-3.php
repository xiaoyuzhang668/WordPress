...
<section class="clear">
		...
		<div class="card text-center"
      	...
      	<?php endif; ?>
      	<div class="card-img-overlay d-flex text-center align-self-center justify-content-center align-items-center">
    ...
    <div class="container">
					...
					<div id="Cars2" class="desc">
							<?php echo do_shortcode('[ea_bootstrap width=”800px” scroll_off=”true” layout_cols=”2″]'); ?>
					</div>
